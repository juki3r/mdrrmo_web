...
export default function Certificates() {
  ...
  const updateStatus = async (id, status) => {
    try {
      ...
      fetchCertificates(page, search);f
    } catch (err) {
      console.error(err);
                        ...
                        <td colSpan="5" className="text-center py-5">
                          <div className="d-flex flex-column align-items-center justify-content-center">
                            ...
                            <small className="text-secondary">
                              Try adjusting your search or add a new certificate request.
                            </small>
                  ...
                  <div className="row g-2">
                    ...
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        <option value="Certificate of Low Income">
                        ...
                        <option value="Certificate of Solo Parent">
                          Certificate of Solo Parent
                        </option>

                        <option value="Certificate of Cohabitation">
                          Certificate of Cohabitation
                        </option>

                        <option value="Certificate of Unemployment">
                        ...
                        <option value="Mayor's Permit Endorsement">
                          Mayor's Permit Endorsement
                        </option>

                        {/* LEGAL */}
                        <option value="Barangay Blotter">
                          Barangay Blotter
                        </option>

                        <option value="Certificate to File Action">
                          Certificate to File Action
                        </option>

                        <option value="Summon / Mediation Notice">
                          Summon / Mediation Notice
                        </option>
                        ...
                        <option value="Excavation Clearance">
                          Excavation Clearance
                        </option>

                        {/* TRAVEL */}
                        <option value="Travel Permit">
                          Travel Permit
                        </option>

                        <option value="Tricycle Franchise Clearance">
                          Tricycle Franchise Clearance
                        </option>

                        {/* EVENTS */}
                        <option value="Barangay Event Permit">
                          Barangay Event Permit
                        </option>

                        <option value="Videoke Permit">
                          Videoke Permit
                        </option>

                        {/* MDRR */}
                        <option value="Disaster Assistance Certificate">
                          Disaster Assistance Certificate
                        </option>

                        <option value="Calamity Assistance Certificate">
                          Calamity Assistance Certificate
                        </option>

                        <option value="Emergency Verification Certificate">
                          Emergency Verification Certificate
                        </option>
